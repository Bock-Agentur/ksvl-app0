...
/**
 * File Detail Drawer/Sidebar
 * Full-height drawer on mobile, sidebar on desktop
 */
export function FileDetailDrawer({
    ...
    <div className="space-y-6">
      ...
      <div className="bg-muted rounded-lg overflow-hidden">
        {file.file_type === 'image' && fileUrl ? (
          <img src={fileUrl} alt={file.filename} className="w-full h-auto" />
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        <SheetHeader>
          <SheetTitle>Datei-Details</SheetTitle>
        </SheetHeader>
