    ...
    <div className="w-full space-y-4 px-2 sm:px-4">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
        <div className="flex items-center gap-2 sm:gap-4 w-full sm:w-auto justify-center sm:justify-start">
          ...
          <div className="text-center sm:text-left min-w-0">
            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground">
              {viewMode === "week" ? formatWeekRange() : format(selectedDay, "dd. MMMM yyyy", { locale: de })}
            </h1>
            <div className="text-xs text-muted-foreground mt-1">
              {viewMode === "week" ? `KW ${getWeekNumber()}` : format(selectedDay, "EEEE", { locale: de })}
            </div>
          </div>
        ...
        <div className="flex items-center gap-4">
          {canManageSlots && (
            <Button 
              onClick={() => onSlotEdit(undefined, { 
                date: format(viewMode === "day" ? selectedDay : new Date(), 'yyyy-MM-dd'), 
                time: "08:00" 
              })}
              size="sm"
