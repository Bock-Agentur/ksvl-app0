...
export function SlotManagement() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden bg-background max-w-7xl mx-auto">
      {/* Fixed Top Card */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <Select value={selectedCraneOperator} onValueChange={setSelectedCraneOperator}>
                        ...
                        <SelectContent>
                          ...
                          {allCraneOperators.map((operator) => (
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-center">
                  <StatusLabel status={getSlotStatus(selectedSlotForDetails, slots) as "available" | "booked" | "blocked"} size="md">
                    {getSlotStatus(selectedSlotForDetails, slots) === 'booked' 
                      ? "Gebucht"
                      : getSlotStatus(selectedSlotForDetails, slots) === 'blocked'
                        ? "Gesperrt"
                        : "Verfügbar"}
                  </StatusLabel>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="pl-6 space-y-2">
                    ...
                    {selectedSlotForDetails.craneOperator.email && (
                      <div className="flex items-center gap-2">
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="pl-6 space-y-2">
                        ...
                        {selectedSlotForDetails.member.email && (
                          <div className="flex items-center gap-2">
                            <Mail className="w-3 h-3 text-muted-foreground" />
                ...
                <div className="flex gap-2">
                  ...
                  {!selectedSlotForDetails.isBooked && (
                    <Button
                      variant="outline"
                      onClick={() => {
                        setSelectedSlotForDetails(null);
